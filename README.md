...
*   **[go-swagger](https://github.com/go-swagger/go-swagger)**: Contains a powerful **`flatten`** command (`swagger flatten`) that extracts inline schemas and complex constructs into distinct definitions in a single step.
